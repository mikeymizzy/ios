...
ThemeData dark({Color color = const Color(0xFF082A73)}) => ThemeData(
  fontFamily: AppConstants.fontFamily,
  primaryColor: color,
  secondaryHeaderColor: const Color(0xFF00C99A),
  ...
  colorScheme: ColorScheme.dark(primary: color, secondary: const Color(0xFF00C99A)).copyWith(surface: const Color(0xFF191A26)).copyWith(error: const Color(0xFFdd3135)),
